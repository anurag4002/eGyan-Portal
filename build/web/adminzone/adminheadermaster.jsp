            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedCsontent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0" >
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="adminwelcome.jsp"><b>Dashboard</b></a>
                        </li>
                        
                         <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="notification.jsp"><b>Notification</b></a>
                        </li>
                         ...
                         <li class="nav-item">
                            <a class="nav-link" href="usm.jsp" ><b>Upload Study Material</b></a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="studentlist.jsp" ><b>studentlist</b></a>
                        </li>
                        <!--<li class="nav-item">
